"""Модуль управления сетевым подключением Anthropic Claude Code с гарантией чистоты маршрута (Fail-Safe Channel Isolation).
...
Обеспечивает:
- Настройку выделенного тестового сокета для Claude Code
