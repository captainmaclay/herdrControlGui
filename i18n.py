...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "aiw_title": "👁 aiWatcher",
        "aiw_desc": "Watchdog for WSL2 services: checks AionUi and OmniRoute every few seconds and restarts them if they are down.",
        "aiw_badge_on": "WATCHER: ON",
        "aiw_badge_off": "WATCHER: OFF",
        "aiw_badge_external": "EXTERNAL aiWatcher",
        "aiw_btn_turn_on": "▶ Turn ON Watcher",
        "aiw_btn_turn_off": "⏸ Turn OFF Watcher",
        "aiw_btn_check_now": "🔄 Check now",
        "aiw_interval": "interval: {sec} s",
        "aiw_app_aionui": "AionUi (web UI :25808)",
        "aiw_app_omniroute": "OmniRoute (AI gateway :20128)",
        "aiw_st_unknown": "[ ? ]",
        "aiw_st_running": "🟢 RUNNING",
        "aiw_st_starting": "🟡 STARTING...",
        "aiw_st_restarted": "🟠 RESTARTED",
        "aiw_st_start_failed": "🔴 START FAILED",
        "aiw_st_disabled": "Skipped (Disabled)",
        "aiw_st_paused": "[ PAUSED ]",
        "aiw_st_external": "External aiWatcher",
        "aiw_log_title": "Watcher Logs",
        "aiw_st_unhealthy": "🟠 NOT RESPONDING (502)",
        "aiw_st_healing": "🔧 HEALING...",
        "aiw_st_heal_failed": "🔴 HEALING FAILED",
        "aiw_btn_restart_aionui": "♻ Restart AionUi (clean)",
        "aiw_btn_repair_db": "🛠 Repair AionUi DB",
        "aiw_action_restart": "Clean restart of AionUi",
        "aiw_action_repair": "AionUi database repair",
        "aiw_confirm_repair_db": "Repair the AionUi database?\n\nAionUi will be stopped (the watcher pauses automatically), the database will be backed up together with -wal/-shm into ~/.aionui-web/db_backups, rebuilt and AionUi started again. It may take a few minutes.",
        "aiw_external_warning": "A separate aiWatcher (D:\\My files\\aiWatcher) is running. The built-in watcher is paused so the two do not start services twice.",
        "aiw_btn_stop_external": "Stop external aiWatcher",
        "aiw_confirm_stop_external": "Stop the separate aiWatcher ({count} process(es)) and disable its autostart?\n\nThe built-in aiWatcher in Herdr Control Center will take over.",
        "aiw_external_stopped": "External aiWatcher stopped ({count} process(es)).",
        "aiw_autorun_disabled": "Its autostart was disabled (ai_watcher_autorun.vbs → .disabled).",
    ...
    "ru": {
        ...
        # aiWatcher (встроенный сторож сервисов WSL2)
        "aiw_title": "👁 aiWatcher",
        "aiw_desc": "Сторож сервисов WSL2: каждые несколько секунд проверяет AionUi и OmniRoute и перезапускает упавшие.",
        "aiw_badge_on": "СТОРОЖ: ВКЛ",
        "aiw_badge_off": "СТОРОЖ: ВЫКЛ",
        "aiw_badge_external": "ВНЕШНИЙ aiWatcher",
        "aiw_btn_turn_on": "▶ Включить сторож",
        "aiw_btn_turn_off": "⏸ Выключить сторож",
        "aiw_btn_check_now": "🔄 Проверить сейчас",
        "aiw_interval": "интервал: {sec} с",
        "aiw_app_aionui": "AionUi (веб-интерфейс :25808)",
        "aiw_app_omniroute": "OmniRoute (AI-шлюз :20128)",
        "aiw_st_unknown": "[ ? ]",
        "aiw_st_running": "🟢 РАБОТАЕТ",
        "aiw_st_starting": "🟡 ЗАПУСКАЕТСЯ...",
        "aiw_st_restarted": "🟠 ПЕРЕЗАПУЩЕН",
        "aiw_st_start_failed": "🔴 НЕ ЗАПУСТИЛСЯ",
        "aiw_st_disabled": "Пропуск (выключен)",
        "aiw_st_paused": "[ ПАУЗА ]",
        "aiw_st_external": "Внешний aiWatcher",
        "aiw_log_title": "Журнал сторожа",
        "aiw_st_unhealthy": "🟠 НЕ ОТВЕЧАЕТ (502)",
        "aiw_st_healing": "🔧 ЛЕЧЕНИЕ...",
        "aiw_st_heal_failed": "🔴 ЛЕЧЕНИЕ НЕ ПОМОГЛО",
        "aiw_btn_restart_aionui": "♻ Перезапустить AionUi (чисто)",
        "aiw_btn_repair_db": "🛠 Починить базу AionUi",
        "aiw_action_restart": "Чистый перезапуск AionUi",
        "aiw_action_repair": "Ремонт базы AionUi",
        "aiw_confirm_repair_db": "Починить базу AionUi?\n\nAionUi будет остановлен (сторож сам встанет на паузу), база сохранится вместе с -wal/-shm в ~/.aionui-web/db_backups, будет пересобрана, и AionUi запустится снова. Это может занять несколько минут.",
        "aiw_external_warning": "Запущен отдельный aiWatcher (D:\\My files\\aiWatcher). Встроенный сторож на паузе, чтобы сервисы не запускались дважды.",
        "aiw_btn_stop_external": "Остановить внешний aiWatcher",
        "aiw_confirm_stop_external": "Остановить отдельный aiWatcher ({count} процесс(ов)) и отключить его автозапуск?\n\nЕго работу возьмёт на себя встроенный aiWatcher в Herdr Control Center.",
        "aiw_external_stopped": "Внешний aiWatcher остановлен (процессов: {count}).",
        "aiw_autorun_disabled": "Его автозапуск отключён (ai_watcher_autorun.vbs → .disabled).",
